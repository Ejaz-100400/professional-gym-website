...
export default function ExerciseCateg(){
    ...
    <div className="exercise--categ m-5 p-2 d-flex">
        ...
        <h1 className='category--context text-left text-light d-flex'>The best moves to build your body muscles <img src={muscleicon} className="m-5 d-flex icon"width="100"/></h1>
